...
%% Change these:
\newcommand{\projecttitle}{GMIT Cross-Platform Mobile Banking Application}
\newcommand{\projectauthor}{Alan Niemiec \\[0.2cm] Shane Gleeson \\[0.2cm] Dara Starr}
